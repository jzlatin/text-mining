# cite: https://www.jcchouinard.com/get-reddit-api-credentials-with-praw/
...
def receive_connection():
    """
    Wait for and return a connected sockte.
    Opens a TCP connected on port 8080, and waits for a single client.
    """
